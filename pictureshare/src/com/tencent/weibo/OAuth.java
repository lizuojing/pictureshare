...
public class OAuth {
	public static final String URL_ACTIVITY_CALLBACK = "chouti://BindAccount?from=tencent";
	public static final String FROM = "chouti";

	
//	private String oauth_consumer_key = "801006016";// AppKey(client credentials)
//	private String oauth_consumer_secret = "05564c81cc14b7692efbd037faedd5e5";// 签名密钥1
	...
	public OAuth(String oauth_consumer_key, String oauth_consumer_secret, String oauth_callback) {
		super();
		ApiConfig.TENCENT_OAUTH_CONSUMER_KEY = oauth_consumer_key;
		ApiConfig.TENCENT_OAUTH_CONSUMER_SECRET = oauth_consumer_secret;
		this.oauth_callback = oauth_callback;
	}
	...
	public List<QParameter> getParams() {
		...
		if (null != ApiConfig.TENCENT_OAUTH_CONSUMER_KEY && !"".equals(ApiConfig.TENCENT_OAUTH_CONSUMER_KEY.trim()))
			parameters.add(new QParameter("oauth_consumer_key", ApiConfig.TENCENT_OAUTH_CONSUMER_KEY));
	...
	public String getOauth_consumer_key() {
		return ApiConfig.TENCENT_OAUTH_CONSUMER_KEY;
	}
	...
	public String getOauth_consumer_secret() {
		return ApiConfig.TENCENT_OAUTH_CONSUMER_SECRET;
	}
