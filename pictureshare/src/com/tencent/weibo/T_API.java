...
public class T_API extends RequestAPI {
	 ...
	 * @throws Exception
	 */
	public String add(OAuth oauth, String format, String content, String clientip, String jing, String wei)
			throws Exception {
		List<QParameter> parameters = new ArrayList<QParameter>();
		parameters.add(new QParameter("format", format));
	 ...
	 * @throws Exception
	 */
	public String re_add(OAuth oauth, String format, String content, String clientip, String jing, String wei,
			String reid) throws Exception {
		List<QParameter> parameters = new ArrayList<QParameter>();
		parameters.add(new QParameter("format", format));
		parameters.add(new QParameter("content", content));
		parameters.add(new QParameter("clientip", clientip));
	 ...
	 * @throws Exception
	 */
	public String comment(OAuth oauth, String format, String content, String clientip, String jing, String wei,
			String reid) throws Exception {
		List<QParameter> parameters = new ArrayList<QParameter>();
		parameters.add(new QParameter("format", format));
		parameters.add(new QParameter("content", content));
	 ...
	 * @throws Exception
	 */
	public String reply(OAuth oauth, String format, String content, String clientip, String jing, String wei,
			String reid) throws Exception {
		List<QParameter> parameters = new ArrayList<QParameter>();
		parameters.add(new QParameter("format", format));
		parameters.add(new QParameter("content", content));
	 ...
	 * @throws Exception
	 */
/*	public String add_pic(OAuth oauth, String format, String content, String clientip, String jing, String wei,
	...
	public String add_pic(OAuth oauth, String format, String content, String clientip, String jing, String wei,
			String picUrl) throws Exception {
		List<QParameter> parameters = new ArrayList<QParameter>();
		parameters.add(new QParameter("format", format));
		parameters.add(new QParameter("content", content));
		parameters.add(new QParameter("clientip", clientip));
		parameters.add(new QParameter("jing", jing));
		parameters.add(new QParameter("wei", wei));
		parameters.add(new QParameter("pic_url", picUrl));

		return postFile("http://open.t.qq.com/api/t/add_pic_url", parameters, null,oauth);
	}
	 ...
	 * @throws Exception
	 */
	public String re_list(OAuth oauth, String format, String rootid, String pageflag, String pagetime) throws Exception {
		List<QParameter> parameters = new ArrayList<QParameter>();
		parameters.add(new QParameter("format", format));
	 ...
	 * @throws Exception
	 */
	public String add_music(OAuth oauth, String format, String content, String clientip, String jing, String wei,
			String url, String title, String author) throws Exception {
		List<QParameter> parameters = new ArrayList<QParameter>();
		parameters.add(new QParameter("format", format));
		parameters.add(new QParameter("content", content));
		parameters.add(new QParameter("clientip", clientip));
	 ...
	 * @throws Exception
	 */
	public String add_video(OAuth oauth, String format, String content, String clientip, String jing, String wei,
