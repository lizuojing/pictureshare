...
public class ImageUtil {
	...
	public static Bitmap drawableToBitmap(Drawable drawable) {
	     ...
	     * @return
	     */
	    public static Bitmap getThumbnail(final String filePath, final int newW, final int newH,int orientation)
	    {
		...
		private static Bitmap scaleBitmap(final String filePath, final int newW, final int newH,int orientation) {
			Bitmap bitmap;
    		...
    		scale=scale/(1.0f/((int)(1/scale)<=1?1:(int)(1/scale)));
	    ...
	    private static void saveBitmapToGalleryThumbnailCache(String filePath,Bitmap bitmap) {
		...
		private static Bitmap getBitmapFromGalleryThumbnailCache(String filePath) {
			String fileName=getFileNameNoExtension(filePath);
			String thumbnailFilePath=SettingLoader.getGalleryThumbnailCacheDir().getAbsolutePath()+"/"+fileName;
	     ...
	     * @return
	     */
	    public static Bitmap compressBitmap(final Bitmap bm, final int newW, final int newH)
	    {
